    ...
    pt-8 max-w-13 md:max-w-60 w-full border-r border-borderColor text-sm'>
        ...
        <div className='group relative'>
            <label htmlFor="image">
                ...
                "https://images.pexels.com/photos/13600373/pexels-photo-13600373.jpeg?_gl=1*11sfw55*_ga*MzkxNjk5MDMyLjE3NDgxNDk5OTk.*_ga_8JE65Q40S6*czE3NTIzMTIzODQkbzMkZzEkdDE3NTIzMTI0MDgkajM2JGwwJGgw"    
        ...
        {image && (
            ...
            cursor-pointer' onClick={updateImage} >Save <img src={assets.check_icon} width={13}/></button>
        )}
        ...
        <div className='w-full'>
            {ownerMenuLinks.map((link, index)=> (
                ...
                items-center gap-2 w-full py-3 pl-4 first:mt-6 ${link.path === 
