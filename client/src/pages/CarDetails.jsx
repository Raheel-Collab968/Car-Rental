         ...
         text-gray-500'>
          ...
          font-semibold'>{currency}{car.pricePerDay} <span className='text-base
           ...
           <div className='flex flex-col gap-2'>
            ...
            <input type="date" value={pickupDate} onChange={(e)=>setPickupDate(e.target.value)} className='border
             border-borderColor px-3 py-2 rounded-lg' required id='pickup-date' min={new Date().toISOString().split('T')[0]} />
           </div>
