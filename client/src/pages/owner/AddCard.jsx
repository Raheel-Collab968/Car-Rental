  ...
  text-sm mt-6 max-w-xl'>
    ...
    <div className='flex items-center gap-2 w-full'>
      <label htmlFor="car-image">
        ...
        <input type="file" name="" id="car-image" accept='image/*' hidden onChange={
    ...
    {/* Car Transmission Fuel Type, Seating Capacity */}
      ...
      {/* Car Description */}
       <div className='flex flex-col w-full'>
        ...
        powerful engine.' required className='px-3 py-2 mt-1 border border-borderColor
         rounded-md outline-none' value={car.description} onChange={e=> setCar({...car,
